...
def test_japanese_safety_and_guidance_copy_uses_task_centered_terms(locales):
    ...
    checked_keys = {
        ...
        "dimensionality.panel_select_caption",
        ...
        "visuals_top.panel_select_label",
        "visuals_top.panel_select_help",
        "visuals_top.panel_select_caption",
        "visuals.map_panel_select_label",
        "visuals.map_panel_select_help",
        "visuals.map_panel_select_caption",
